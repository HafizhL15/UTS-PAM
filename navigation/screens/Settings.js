...
import { View, Text, StatusBar, StyleSheet, TouchableOpacity, Button} from 'react-native';
        ...
        <View style={{ flex: 1}}>
            ...
            <View style={styles.kotak}>
                ...
                <Button
                    ...
                    color='#f5a742'
                    onPress={console.log('TES BATAL')}
                />
                        
            </View>

            <View style={styles.kotak}>
                <Text style={styles.alamat}>Bakauheni         ->          Tanjung Priok</Text>

                <Text style={styles.jadwalMasuk}>Jadwal Masuk Pelabuhan</Text>
                <Text style={styles.tanggal}>Kamis, 18 Maret 2022</Text>
                <Text style={styles.tanggal}>09.30 WIB</Text>

                <Text style={[styles.jadwalMasuk, {paddingTop:10}]}>Layanan</Text>
                <Text style={[styles.tanggal, {paddingBottom:5}]}>Ekonomi</Text>
                ...
                />
                <Text style={styles.harga}>Dewasa x6                                        Rp 390.000,00</Text>
